...
| brain v1.x（openclaw 实现） | brain v2（诚实睡眠回路） |
|---|---|
...
└─────────────────────┬─────────────────────────────────┘
        ...
        └─────────────────────────────────┘
                    ...
                    夜里（每天 03:00 cron）
┌───────────────────────────────────────────────────────┐
│  Sleep Consolidation (DeepSeek 无限免费额度跑)         │
├───────────────────────────────────────────────────────┤
│  扫今天所有对话+记忆条目                                │
│  每条用诚实回路重新评估可信度                           │
...
- 我们的优势: 个人 agent + 无限 DeepSeek + 钩子基础设施

---

## 下次会话时我要做的第一件事

读 `protocol.md` 并严格遵守。这是我和爸爸的约定。

---
*2026-05-26 凌晨 by 泡咪 (with 爸爸 wby1999)*
